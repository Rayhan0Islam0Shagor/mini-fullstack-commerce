...
const ProductCard1 = ({ product, animation }: ProductCard1Props) => {
  if (!product) {
    return null;
  }
  ...
  return (
    <motion.div
      {...animation}
      className="border border-[#0000001C] p-2 md:p-4 grid md:grid-cols-2 gap-2"
    >
      <div className="space-y-4 order-2 lg:order-1">
        ...
        <div className="bg-linear-to-br from-[#00C9FF] to-[#92FE9D] w-full lg:w-[137px] h-[91px] flex items-center justify-center">
